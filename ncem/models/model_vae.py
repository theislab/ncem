...
from ncem.models.layers import Encoder, Decoder, \
    GaussianOutput, GaussianConstDispOutput, NegBinOutput, NegBinSharedDispOutput, NegBinConstDispOutput, \
    SamplingPrior, PreprocInput
...
class ModelVAE:
    def __init__(
        ...
        self.encoder = tf.keras.Model(
            inputs=[input_x, input_categ_condition, input_g],
        ...
        self.decoder_sampling = tf.keras.Model(
            ...
            name="variational-decoder-sampling"
        )
