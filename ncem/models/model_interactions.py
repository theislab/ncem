...
class ModelInteractions:
    def __init__(
        ...
        input_target = tf.keras.Input(
            ...
            name='target')
        input_interaction = tf.keras.Input(
            shape=(in_node_dim, interaction_dim),
            name='interaction', sparse=True)
        ...
        if use_interactions:
            interactions = DenseInteractions(
                in_node_dim=in_node_dim, interaction_dim=interaction_dim
            )(input_interaction)
